...
# instacart betavae
python run_experiment.py --dataset instacart --model betavae --batch-size 32 --vae_enable_knn True --num_nearest_neighbors 50 --within_decay_rate 0.9 --group_decay_rate 0.7 --group_count 3 --alpha 0.9 --save_user_metrics True
# tafeng betavae
python run_experiment.py --dataset tafeng --model betavae --batch-size 32 --vae_enable_knn True --num_nearest_neighbors 10 --within_decay_rate 0.9 --group_decay_rate 0.7 --group_count 7 --alpha 0.7 --save_user_metrics True
# dunnhumby betavae
python run_experiment.py --dataset dunnhumby --model betavae --batch-size 32 --vae_enable_knn True --num_nearest_neighbors 20 --within_decay_rate 0.9 --group_decay_rate 0.6 --group_count 3 --alpha 0.2 --save_user_metrics True
# valuedshoppers betavae
python run_experiment.py --dataset valuedshopper --model betavae --batch-size 32 --vae_enable_knn True --num_nearest_neighbors 10 --within_decay_rate 1 --group_decay_rate 0.6 --group_count 7 --alpha 0.7 --save_user_metrics True
# tmall betavae
python run_experiment.py --dataset tmall --model betavae --batch-size 32 --vae_enable_knn True --num_nearest_neighbors 250 --within_decay_rate 0.6 --group_decay_rate 0.8 --group_count 18 --alpha 0.7 --save_user_metrics True
# taobao betavae
python run_experiment.py --dataset taobao --model betavae --batch-size 32 --vae_enable_knn True --num_nearest_neighbors 150 --within_decay_rate 0.6 --group_decay_rate 0.8 --group_count 10 --alpha 0.1 --save_user_metrics True